 ...
 *
 * <p>Generates readable JSON output for Expr and Stmt nodes. Useful for debugging, learning, or
 * feeding AST to tools/AI.
 */
public class AstPrinter implements Expr.Visitor<String>, Stmt.Visitor<String> {
  ...
  public String visitLiteralExpr(Expr.Literal expr) {
    return "{\n"
        ...
        + INDENT
        + "\"value\": "
        + (expr.value == null ? "null" : quote(expr.value.toString()))
        + "\n"
        + "}";
  }
  ...
  /**
   * Standalone main method for testing the AST printer. Generates a sample expression and prints
