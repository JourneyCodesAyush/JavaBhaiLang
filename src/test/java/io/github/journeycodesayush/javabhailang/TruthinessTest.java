...
public class TruthinessTest {
  ...
  public void testZeroIsFalsey() {
    String output =
        TestHelper.runAndCaptureOutput(
            "bhai ye hai a = 0;" + "agar bhai (!a) { bol bhai 'zero is falsey'; }");
  ...
  public void testNonZeroIsTruthy() {
    String output =
        TestHelper.runAndCaptureOutput(
            "bhai ye hai a = 42;" + "agar bhai (a) { bol bhai 'non-zero is truthy'; }");
  ...
  public void testNegativeNumberIsTruthy() {
    String output =
        TestHelper.runAndCaptureOutput(
            "bhai ye hai a = -5;" + "agar bhai (a) { bol bhai 'negative number is truthy'; }");
  ...
  public void testNullIsFalsey() {
    String output =
        TestHelper.runAndCaptureOutput(
            "bhai ye hai a = nalla;" + "agar bhai (!a) { bol bhai 'nalla is falsey'; }");
  ...
  public void testBooleanTruthiness() {
    ...
    assertEquals(
        "true is truthy" + System.lineSeparator() + "false is falsey" + System.lineSeparator(),
        output);
  }
  ...
  public void testEmptyStringIsTruthy() {
    String output =
        TestHelper.runAndCaptureOutput(
            "bhai ye hai s = '';" + "agar bhai (s) { bol bhai 'empty string is truthy'; }");
  ...
  public void testLogicalNot() {
    ...
    assertEquals(
        "not zero is true"
            ...
            + "double not returns original truthiness"
            + System.lineSeparator(),
        output);
  }
