...
public class InterpreterTest {
  ...
  public void testWhileLoopWithBreak() {
    ...
    assertEquals("1" + System.lineSeparator() + "2" + System.lineSeparator(), output);
  }
  ...
  public void testMultiplePrintArguments() {
    String output =
        TestHelper.runAndCaptureOutput(
            "bhai ye hai a = 5;" + "bhai ye hai b = 10;" + "bol bhai \"The values are:\", a, b;");
  ...
  public void testStringConcatenation() {
    String output =
        TestHelper.runAndCaptureOutput(
            "bhai ye hai str = \"Hello\";" + "str += \" Bhai\";" + "bol bhai str;");
